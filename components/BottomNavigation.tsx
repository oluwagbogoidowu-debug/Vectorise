  ...
  const navItems = [
    {
      ...
      icon: (active: boolean) => (
        <div className="relative">
          <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${active ? 'text-[#0E7850]' : 'text-gray-400'}`} fill={active ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={active ? 0 : 2}>
    ...
    },
    {
      ...
      path: '/my-sprints',
      icon: (active: boolean) => (
        <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${active ? 'text-[#0E7850]' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
