...
const BottomNavigation: React.FC = () => {
  ...
  const navItems = [
    {
      ...
      icon: (active: boolean) => (
        <div className="relative">
          <svg xmlns="http://www.w3.org/2000/svg" className={`h-7 w-7 ${active ? 'stroke-2.5' : 'stroke-2'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="fixed bottom-0 left-0 z-50 w-full bg-white border-t border-gray-100 shadow-[0_-8px_16px_-8px_rgba(0,0,0,0.05)] safe-area-pb">
