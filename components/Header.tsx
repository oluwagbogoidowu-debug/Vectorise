...
import ParticipantDrawerMenu from './ParticipantDrawerMenu';
      ...
      <div className="max-w-md mx-auto bg-white rounded-full border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center justify-between px-6 py-2.5 pointer-events-auto relative">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <button 
            ...
            className="p-2 -ml-2 rounded-2xl text-gray-600 hover:text-gray-950 hover:bg-gray-100/80 active:scale-95 transition-all cursor-pointer"
            title="Open menu"
          >
        ...
        {!hasPendingTask ? (
          <div className="flex items-center flex-1 ml-4 border-l border-gray-100 pl-4 h-8 gap-3">
            ...
            <Link to="/explore" className="flex flex-col text-left group">
              <span className="text-[8px] font-black uppercase tracking-[0.2em] leading-none transition-colors text-gray-300 group-hover:text-primary">Explore</span>
              <span className="text-[8px] font-black uppercase tracking-[0.2em] leading-none transition-colors text-gray-300 group-hover:text-primary">Sprints</span>
            </Link>
          </div>
        ) : (
