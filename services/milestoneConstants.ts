...
export const MILESTONES: MilestoneDefinition[] = [
    // Core Progress
    { id: 'first_leap', title: 'First Leap', description: 'Completed the first move of your first sprint.', icon: '🚀', targetValue: 1, points: 10, category: 'coreProgress', isAutoClaim: true },
    { id: 's2', title: 'First Sprint', description: 'Completed your first sprint on Vectorise.', icon: '🏁', targetValue: 1, points: 15, category: 'coreProgress' },
