...
// Fix: Added missing import for LocalLogo
                        ...
                        <div className="relative h-[220px] sm:h-[300px] lg:h-[380px] rounded-[2.5rem] overflow-hidden shadow-2xl group border-4 border-white">
                            ...
                            <div className="absolute bottom-8 left-8 right-8 text-white">
                                <div className="flex flex-wrap gap-2 mb-4">
                                    ...
                                    <span className="px-3 py-1 bg-white/10 backdrop-blur-md rounded-lg text-[8px] font-black uppercase tracking-widest border border-white/10">{sprint.difficulty}</span>
                                </div>
                        ...
                        <section className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-gray-100 shadow-sm animate-fade-in relative overflow-hidden">
                            <div className="relative z-10">
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    {sprint.outcomeTag && (
                                        <span className="bg-primary/10 text-primary px-3 py-1 rounded-lg text-[8px] font-black uppercase tracking-widest italic">{sprint.outcomeTag}</span>
                                    )}
                                </div>
                                <div className="space-y-8 text-gray-600 leading-relaxed text-[12px] font-medium">
                        ...
                        {sprint.methodSnapshot && sprint.methodSnapshot.length > 0 && (
                            <section className="bg-[#0A0F1D] text-white rounded-[2.5rem] p-10 md:p-16 relative overflow-hidden shadow-2xl border border-white/5 group">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-center text-primary font-black uppercase tracking-[0.4em] text-[9px] pt-16 border-t border-white/5 opacity-60 mt-16">
                    ...
                    <aside className="lg:col-span-4 space-y-6">
                        <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-xl lg:sticky lg:top-6 overflow-hidden relative">
                            ...
                            <div className="mt-12 pt-10 border-t border-gray-50 flex flex-col items-center text-center">
                                <img src={sprintCoach.profileImageUrl} alt="" className="w-16 h-16 rounded-[1.5rem] object-cover border-4 border-white shadow-xl mb-4" />
                                <SectionHeading>Guided By</SectionHeading>
                                <h4 className="text-lg font-black text-dark tracking-tight leading-none mb-1">{sprintCoach.name}</h4>
                                <p className="text-[9px] font-black text-gray-300 uppercase tracking-[0.2em]">{sprintCoach.niche}</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-dark rounded-[2.5rem] p-10 text-white relative overflow-hidden group shadow-2xl border border-white/5">
                            <div className="relative z-10">
                                ...
                                <p className="text-base font-medium italic leading-relaxed opacity-90 mb-8">
                            ...
                            <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-primary/10 rounded-full blur-3xl group-hover:scale-125 transition-transform duration-1000"></div>
                        </div>
                    </aside>
                </div>
            </div>
