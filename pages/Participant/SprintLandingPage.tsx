                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        {sprint.methodSnapshot && sprint.methodSnapshot.length > 0 && (
                            <section className="bg-primary text-white rounded-[3rem] p-10 md:p-16 relative overflow-hidden shadow-2xl border border-white/5 group">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-center text-primary font-black uppercase tracking-[0.4em] text-[10px] pt-20 border-t border-white/5 opacity-60 mt-20">
                    ...
                    <aside className="lg:col-span-4 space-y-6">
                        ...
                        <div className="bg-dark rounded-[3rem] p-12 text-white relative overflow-hidden group shadow-2xl border border-white/5">
                            ...
                            <div className="absolute -bottom-4 -right-4 w-40 h-40 bg-primary/10 rounded-full blur-3xl group-hover:scale-125 transition-transform duration-1000"></div>
                        </div>
                    </aside>
                </div>
            </div>
