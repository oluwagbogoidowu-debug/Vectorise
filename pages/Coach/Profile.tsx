            ...
            <main className="flex-1 overflow-y-auto custom-scrollbar px-4 py-4 space-y-5">
                ...
                <section className="animate-fade-in">
                    <div className="flex items-center justify-between mb-2 px-1">
                        ...
                        <a href="#" className="text-[8px] font-black text-primary uppercase tracking-widest hover:underline">See more</a>
                    </div>
                    <div className="space-y-2">
                        {/* Placeholder for badge items */}
                        <div className="bg-white rounded-2xl p-3 border border-gray-100 shadow-sm flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                <h4 className="text-[9px] font-black text-gray-900 truncate uppercase tracking-tight">First Sprint Launched</h4>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div className="px-1">
                    <Link to="/coach/settings" className="w-full py-4 bg-white border border-gray-100 rounded-[2rem] shadow-sm flex items-center justify-between px-6 group active:scale-[0.98] transition-all">
