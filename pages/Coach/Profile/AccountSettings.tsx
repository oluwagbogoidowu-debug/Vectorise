    ...
    <div className="bg-[#FDFDFD] h-screen w-full font-sans overflow-hidden flex flex-col animate-fade-in">
      ...
      <main className="flex-1 overflow-y-auto p-6 space-y-4">
        <div className="space-y-2">
          ...
          <Link to="/coach/profile/settings/edit" className="flex items-center justify-between p-5 bg-white border border-gray-100 rounded-3xl shadow-sm group active:scale-[0.98] transition-all">
