            ...
            <div className="max-w-7xl mx-auto">
                <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10 pb-8 border-b border-gray-150">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-black text-gray-950 tracking-tight leading-none mb-1">Sprint Preview</h1>
                            <p className="text-[10px] font-black text-primary uppercase tracking-[0.2em]">Gain Clarity First</p>
                        </div>
                    </div>

                    {/* Participant Mode Toggle Button */}
                    <div className="flex items-center gap-4 bg-white px-5 py-3 rounded-2xl border border-gray-200 shadow-sm">
                        <div className="flex items-center gap-2">
                            <Eye className="w-4 h-4 text-primary" />
                            <span className="text-[10px] font-black text-gray-800 uppercase tracking-widest">Preview as Participant</span>
                        </div>
                        <button
                            onClick={() => {
                            ...
                            className={`w-12 h-6 rounded-full transition-colors duration-300 relative focus:outline-none cursor-pointer ${isSimulator ? 'bg-emerald-500 shadow-lg shadow-emerald-500/20' : 'bg-gray-250 border border-gray-300'}`}
                        >
                            <div className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-transform duration-300 shadow-sm ${isSimulator ? 'translate-x-6' : 'translate-x-1'}`} />
                        </button>
                    </div>
                </header>
                ...
                {isSimulator ? (
                    ...
                    // ----------------- STANDARD FLAT COACH'S PREVIEW -----------------
                    <div className="bg-white p-8 rounded-[2.5rem] border border-gray-150 shadow-sm text-center mb-8">
                        <div className="bg-gray-105 p-1.5 rounded-2xl flex gap-1.5 mb-10 border border-gray-150">
                            <button 
                                onClick={() => setPreviewType('card')}
                                className={`flex-1 py-3 rounded-xl text-[9px] font-black uppercase tracking-wider transition-all duration-300 cursor-pointer ${previewType === 'card' ? 'bg-primary text-white shadow-md shadow-primary/20 scale-102' : 'text-gray-400 hover:text-gray-600'}`}
                            >
                                Deck View
                            </button>
                            <button 
                                onClick={() => setPreviewType('landing')}
                                className={`flex-1 py-3 rounded-xl text-[9px] font-black uppercase tracking-wider transition-all duration-300 cursor-pointer ${previewType === 'landing' ? 'bg-primary text-white shadow-md shadow-primary/20 scale-102' : 'text-gray-400 hover:text-gray-650'}`}
                            >
                                Landing View
                            </button>
                            <button 
                                onClick={() => setPreviewType('daily')}
                                className={`flex-1 py-3 rounded-xl text-[9px] font-black uppercase tracking-wider transition-all duration-300 cursor-pointer ${previewType === 'daily' ? 'bg-primary text-white shadow-md shadow-primary/20 scale-102' : 'text-gray-400 hover:text-gray-650'}`}
                            >
                                Daily Content
                            </button>
                        </div>
                        ...
                        {previewType === 'card' && (
                            <div className="animate-fade-in flex flex-col items-center py-6 text-left">
                        ...
                        {previewType === 'landing' && (
                            <div className="animate-fade-in text-left bg-gray-50/50 -mx-8 -mb-8 p-6 md:p-10 rounded-b-[2.5rem] border-t border-gray-100">
                                <div className="max-w-screen-lg mx-auto">
                                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                        <div className="lg:col-span-8 space-y-8">
                                            ...
                                            <div className="relative h-[280px] sm:h-[340px] rounded-[3rem] overflow-hidden shadow-2xl group border-4 border-white bg-dark">
                                                ...
                                                <div className="absolute bottom-10 left-10 right-10 text-white">
                                                    ...
                                                    <h1 className="text-3xl md:text-5xl font-black tracking-tighter leading-tight mb-4 text-white">
                                            ...
                                            <div className="space-y-8">
                                                <section className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-gray-150 shadow-sm animate-fade-in text-left">
                                                    ...
                                                    <div className="space-y-8">
                                                        {sprint.description && (!Array.isArray(sprint.dynamicSections) || sprint.dynamicSections.filter(s => s.body && s.body.trim()).length === 0) && (
                                                            <div className="text-base md:text-lg text-gray-650 font-medium leading-[1.6]">
                                                                <FormattedText text={sprint.description || sprint.subtitle || ""} />
                                                            </div>
                                                        )}
                                                        ...
                                                        {Array.isArray(sprint.dynamicSections) && sprint.dynamicSections
                                                            ...
                                                            .map((section, index) => (
                                                                <div key={index} className="animate-fade-in pt-6 first:pt-0 border-t first:border-0 border-gray-150">
                                        ...
                                        <aside className="lg:col-span-4 space-y-6">
                                            <div className="bg-white rounded-[3rem] p-10 border border-gray-150 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] overflow-hidden relative group/card text-center text-left">
                                                ...
                                                {/* Coach Info */}
                                                <div className="pt-8 border-t border-gray-150 relative z-10 text-left">
                                                    <p className="text-[10px] font-black text-primary uppercase tracking-[0.4em] mb-4 text-center">Grounded Mentor</p>
                                                    <div className="flex items-center gap-4">
                                                        <img src={displayCoachImage} className="w-14 h-14 rounded-2xl object-cover border-2 border-white shadow-md text-left" alt="" />
                                                        <div className="min-w-0">
                                                            <p className="text-sm font-black text-gray-900 tracking-tight leading-none mb-1 uppercase text-left">{displayCoachName}</p>
                                                            <p className="text-[10px] font-black text-[#159E6A]/80 uppercase tracking-widest mb-1 text-left">{isFoundational ? 'AI Coach' : (coach.niche || 'Grounded Specialist')}</p>
                                                        </div>
                                                    </div>
                                                    <p className="mt-4 text-[11px] text-gray-500 font-medium leading-relaxed italic text-left">{isFoundational ? 'Systems architect for the Vectorise core training modules.' : (coach.bio || 'Authorised Mentor.')}</p>
                                                </div>
                                            </div>
                                        </aside>
                                    </div>
                            ...
                            <div className="animate-fade-in text-left">
                                ...
                                <div className="flex overflow-x-auto gap-3 hide-scrollbar mb-8">
                                    {Array.from({ length: sprint.duration }, (_, i) => i + 1).map((day) => (
                                        <button 
                                            ...
                                            className={`flex-shrink-0 flex flex-col items-center justify-center w-20 h-20 rounded-2xl border transition-all duration-300 relative cursor-pointer ${selectedDay === day ? 'bg-primary border-primary text-white shadow-xl shadow-primary/20 scale-105' : 'bg-gray-55 border-gray-150 text-gray-400 hover:border-primary/30 hover:text-primary hover:bg-white'}`}
                                        >
                                ...
                                {currentDailyContent ? (
                                    <div className="space-y-6 w-full">
                                        <div className="bg-white p-8 rounded-[2.5rem] border border-gray-150 shadow-sm space-y-4 text-left">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="text-sm text-gray-755 font-medium leading-relaxed font-semibold">
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <div className="space-y-6 text-left">
                                                        <div className="p-6 bg-primary/5 rounded-2xl border border-primary/10 relative overflow-hidden animate-fade-in text-left">
                                                            <p className="text-[10px] font-black text-primary uppercase tracking-widest mb-4 text-left">Action Step {i + 1} of {activePrompts.length}</p>
                                                            <div className={`text-gray-900 font-bold leading-relaxed text-sm sm:text-base ${currentDailyContent.taskFootnotes?.[i] ? 'mb-2' : 'mb-4'} text-left`}>
                                                            ...
                                                            {currentDailyContent.taskHints?.[i] && (
                                                                <div className="mb-4 text-left">
                                                                    <button
                                                                        ...
                                                                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[8.5px] font-extrabold uppercase tracking-widest transition-all cursor-pointer ${revealedHints[i] ? 'bg-amber-100 text-amber-700' : 'bg-gray-100 text-gray-400 hover:text-primary hover:bg-primary/5'}`}
                                                                    >
                                                                    ...
                                                                    {revealedHints[i] && (
                                                                        <div className="mt-3 p-3 bg-[#FFFDF5] border border-amber-100 rounded-xl text-[11px] sm:text-xs font-semibold text-amber-900 animate-fade-in leading-relaxed italic text-left">
                                                            ...
                                                            <div className="flex justify-between items-center gap-4 pt-4 border-t border-gray-150">
                                                                {i > 0 ? (
                                                                    <button
                                                                        type="button"
                                                                        onClick={() => setPreviewTaskIndex(i - 1)}
                                                                        className="px-4 py-2 bg-white hover:bg-gray-50 border border-gray-250 rounded-xl text-xs font-bold text-gray-500 hover:text-primary transition-colors cursor-pointer active:scale-95"
                                                                    >
                                                                        Back
                                                                    </button>
                                                                ) : <div />}
                                                                ...
                                                                {i < activePrompts.length - 1 ? (
                                                                    <button
                                                                        type="button"
                                                                        onClick={() => setPreviewTaskIndex(i + 1)}
                                                                        className="px-4 py-2 bg-primary text-white rounded-xl text-xs font-bold shadow-sm shadow-primary/10 cursor-pointer active:scale-95"
                                                                    >
                                                                        Next
                                                                    </button>
                                                                ) : <div />}
                                    ...
                                    <p className="text-center text-gray-550 italic">No content available for Day {selectedDay}.</p>
                                )}
                            </div>
                        )}
                    </div>
