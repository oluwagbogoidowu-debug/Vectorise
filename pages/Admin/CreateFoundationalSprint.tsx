...
import { Sprint, SprintDifficulty, DailyContent, DynamicSection, Coach } from '../../types';
...
const CreateFoundationalSprint: React.FC = () => {
    ...
    const [formData, setFormData] = useState<{
        ...
        title: '',
        subtitle: 'Platform Core Program',
        coverImageUrl: '',
        dynamicSections: [
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <p className="text-gray-400 font-bold uppercase tracking-widest text-sm">Loading Platform Registry...</p>
            </div>
        );
    }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const newSprint: Sprint = {
            ...
            published: true, // Foundational sprints are usually published immediately by admin
            approvalStatus: 'approved', // Foundational sprints are pre-approved
        ...
        // Map dynamic sections to legacy fields for compatibility
        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 pb-32">
            <div className="max-w-7xl mx-auto">
                <header className="flex items-center gap-3 mb-10">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-gray-900 tracking-tight">Create Foundational Sprint</h1>
                        <p className="text-[10px] font-black text-primary uppercase tracking-[0.2em]">Platform Core Program</p>
                    </div>
                </header>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                        ...
                        <form onSubmit={handleSubmit} className="p-8 md:p-12 space-y-20">
                            <section>
                                <div className="flex items-center gap-3 mb-8">
                                    ...
                                    <h4 className="text-[10px] font-black text-primary uppercase tracking-widest">Foundational Identity</h4>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        <label className={labelClasses}>Subtitle / Core Program</label>
                                        <input type="text" name="subtitle" value={formData.subtitle} onChange={handleChange} className={inputClasses} placeholder="Platform Core Program" />
                                    </div>
                                    <div className="md:col-span-2">
                            ...
                            <section>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        <label className={labelClasses}>Platform Category</label>
                            ...
                            <div className="flex justify-end gap-4 pt-10 border-t border-gray-100">
                                <button type="button" onClick={() => navigate('/admin/dashboard')} className="px-8 py-3.5 text-[10px] font-black text-gray-400 uppercase tracking-widest hover:text-red-400 transition-colors">Cancel</button>
                    ...
                    <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-12">
                         <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm text-center">
                            ...
                            <h5 className="text-sm font-black text-gray-900 leading-tight mb-4">Platform Consistency.</h5>
                            ...
                            {previewType === 'card' ? (
                                <div className="animate-fade-in flex flex-col items-center">
                                    ...
                                    <div className="w-full max-w-[320px]">
                                        <SprintCard 
                                            ...
                                            coach={{ name: 'Vectorise Platform', profileImageUrl: 'https://lh3.googleusercontent.com/d/1vYOe4SzIrE7kb6DSFkOp9UYz3tHWPnHw', id: 'admin_core' } as any} 
                                ...
                                <div className="animate-fade-in">
                                    <LandingPreview sprint={previewSprint as Sprint} coach={{ name: 'Vectorise Platform', profileImageUrl: 'https://lh3.googleusercontent.com/d/1vYOe4SzIrE7kb6DSFkOp9UYz3tHWPnHw', id: 'admin_core' } as any} />
                                </div>
                            )}
                         </div>
                    </div>
