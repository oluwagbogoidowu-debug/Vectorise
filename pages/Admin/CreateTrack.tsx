                        ...
                        <div className="bg-white rounded-[3rem] shadow-sm border border-gray-100 p-10 space-y-8">
                            <section>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        <label className={labelClasses}>Track Description</label>
                                        <textarea 
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex -space-x-4 overflow-hidden px-2">
                                        ...
                                        {formData.sprintIds.length === 0 && (
                                            <div className="h-12 w-full border-2 border-dashed border-gray-100 rounded-2xl flex items-center justify-center text-[8px] font-black text-gray-300 uppercase tracking-widest">No Sprints Selected</div>
                                        )}
                                    </div>
                                </div>
