      ...
      <div className="max-w-screen-lg mx-auto px-4 pt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          <div className="lg:col-span-8 space-y-6">
            ...
            {/* Hero Image Section - Moderate Typography */}
            ...
            {/* Transformation Section - Moderate Sizing, No Italics */}
            ...
            {/* Method Snapshot Section - Green Background */}
            ...
            <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-xl lg:sticky lg:top-6 overflow-hidden relative">
              ...
              <div className="space-y-4 mb-10">
                  <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-[1.25rem] border border-gray-100 group transition-all hover:bg-white hover:border-primary/20 hover:shadow-md">
                      ...
                      <div><p className="text-[8px] font-black text-gray-400 uppercase tracking-widest mb-0.5">Timeline</p><p className="text-[11px] font-black text-gray-900 leading-none">{sprint.duration} Continuous Days</p></div>
                  </div>
                  <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-[1.25rem] border border-gray-100 group transition-all hover:bg-white hover:border-primary/20 hover:shadow-md">
                      <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-xl shadow-sm border border-gray-100">⚡</div>
                      <div><p className="text-[8px] font-black text-gray-400 uppercase tracking-widest mb-0.5">Execution</p><p className="text-[11px] font-black text-gray-900 leading-none">{sprint.protocol || 'One action per day'}</p></div>
                  </div>
              </div>
              <div className="space-y-4">
                <Button onClick={handleProceed} className="w-full py-4 rounded-[1.25rem] shadow-2xl shadow-primary/30 text-[10px] uppercase tracking-[0.2em] font-black">Authorize Path &rarr;</Button>
