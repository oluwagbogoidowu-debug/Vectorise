...
const QuizIntro: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen px-6 py-4 bg-primary text-white overflow-hidden relative">
      <div className="flex flex-col h-full w-full max-w-md mx-auto relative z-10">
        ...
        <div className="w-full bg-white/10 rounded-full h-1 mb-8 flex-shrink-0 overflow-hidden">
